...
LLM_EXTRACTION_TIMEOUT_SECONDS = float(os.environ.get("LLM_EXTRACTION_TIMEOUT_SECONDS", "120"))
LLM_EXTRACTION_MAX_TOKENS = int(os.environ.get("LLM_EXTRACTION_MAX_TOKENS", "1400"))
